                                      ...
                                      m.each(t.State.calls, function (a, b) {
                                          b &&
                                              m.each(b[1], function (c, e) {
                                                  var f = s === d ? "" : s;
                                                  return (
                                                      (f !== !0 && b[2].queue !== f && (s !== d || b[2].queue !== !1)) ||
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
                    ...
                    : void this.each(function () {
                          ...
                          function e(b) {
                              ...
                              var q = 0,
                                  ...
                                  s = g.parent();
                              if (
                                  (s.is("body") || (s[0].scrollHeight > s[0].clientHeight && (q = s[0].scrollTop), s[0].scrollWidth > s[0].clientWidth && (r = s[0].scrollLeft)),
                              ...
                              j.css({ position: "absolute", top: g.position().top + p + q, left: o + r }),
                                  j
                                      .stop(!0, !0)
                                      .css("opacity", 0)
                                      .slideDown({
                                  ...
                                  g.bind("click." + g.attr("id"), function (b) {
                                      i ||
                                          (g[0] != b.currentTarget || g.hasClass("active") || 0 !== a(b.target).closest(".dropdown-content").length
                                              ? g.hasClass("active") && (f(), a(document).unbind("click." + j.attr("id")))
    ...
    (function (a) {
        var b = 0,
            ...
            e = {
                init: function (c) {
                    var e = { opacity: 0.5, inDuration: 350, outDuration: 250, ready: void 0, complete: void 0, dismissible: !0, startingTop: "4%", endingTop: "10%" };
                    return (
                        (c = a.extend(e, c)),
                        this.each(function () {
                            var e = a(this),
                                ...
                                g = function () {
                                    ...
                                    e.removeClass("open"),
                                        ...
                                        f.velocity({ opacity: 0 }, { duration: c.outDuration, queue: !1, ease: "easeOutQuart" });
                                    var g = {
                                    ...
                                    e.hasClass("bottom-sheet") ? e.velocity({ bottom: "-100%", opacity: 0 }, g) : e.velocity({ top: c.startingTop, opacity: 0, scaleX: 0.7 }, g);
                                },
                                h = function (f) {
                                    var h = a("body"),
                                        i = h.innerWidth();
                                    if ((h.css("overflow", "hidden"), h.width(i), !e.hasClass("open"))) {
                                        ...
                                        (lStack = ++b),
                                            ...
                                            k.velocity({ opacity: c.opacity }, { duration: c.inDuration, queue: !1, ease: "easeOutCubic" }),
                                        ...
                                        e.hasClass("bottom-sheet")
                                            ...
                                            : (a.Velocity.hook(e, "scaleX", 0.7), e.css({ top: c.startingTop }), e.velocity({ top: c.endingTop, opacity: 1, scaleX: "1" }, l));
                                    }
                                };
                    ...
                    i.wrap(j),
                        i.on("click", function () {
                            ...
                            var r = 0,
                                ...
                                u = 0,
                                v = 0;
                            s > t ? ((r = m / l), (u = 0.9 * j), (v = 0.9 * j * r)) : ((r = l / m), (u = 0.9 * k * r), (v = 0.9 * k)),
            ...
            init: function (b) {
                ...
                return this.each(function (c) {
                    var e,
                        ...
                        v = function (a) {
                            q - a >= 0
                                ? (h.velocity({ right: t(e) }, { duration: s, queue: !1, easing: "easeOutQuad" }), h.velocity({ left: u(e) }, { duration: s, queue: !1, easing: "easeOutQuad", delay: 90 }))
                                : (h.velocity({ left: u(e) }, { duration: s, queue: !1, easing: "easeOutQuad" }), h.velocity({ right: t(e) }, { duration: s, queue: !1, easing: "easeOutQuad", delay: 90 }));
                        };
                    b.swipeable && l > b.responsiveThreshold && (b.swipeable = !1),
                        ...
                        (q = m.index(e)),
                        q < 0 && (q = 0),
                        void 0 !== e[0] && ((f = a(e[0].hash)), f.addClass("active")),
                            ...
                            if (!a(this).attr("target")) {
                                ...
                                e.addClass("active"),
                                    ...
                                    b.swipeable
                                        ...
                                        : (void 0 !== f && (f.show(), f.addClass("active"), "function" == typeof b.onShow && b.onShow.call(this, f)), void 0 === d || d.is(f) || (d.hide(), d.removeClass("active"))),
                      ...
                      f.on({
                              ...
                              var c = function () {
                                  ...
                                  "top" === i
                                      ? ((a = f.offset().top - j - d),
                                        ...
                                        (e = b(c, a, n, j)),
                                        (o = "-10px"),
                                        l.css({ bottom: 0, left: 0, borderRadius: "14px 14px 0 0", transformOrigin: "50% 100%", marginTop: j, marginLeft: n / 2 - r / 2 }))
                                      : "left" === i
                                      ...
                                      : ((a = f.offset().top + f.outerHeight() + d), (c = f.offset().left + g / 2 - n / 2), (e = b(c, a, n, j)), (o = "+10px"), l.css({ top: 0, left: 0, marginLeft: n / 2 - r / 2 })),
                                      k.css({ top: e.y, left: e.x }),
                                      (t = (Math.SQRT2 * n) / parseInt(r)),
                                      (u = (Math.SQRT2 * j) / parseInt(s)),
                                      (v = Math.max(t, u)),
                                      k.velocity({ translateY: o, translateX: q }, { duration: 350, queue: !1 }).velocity({ opacity: 1 }, { duration: 300, delay: 50, queue: !1 }),
                                      l.css({ visibility: "visible" }).velocity({ opacity: 1 }, { duration: 55, delay: 0, queue: !1 }).velocity({ scaleX: v, scaleY: v }, { duration: 300, delay: 0, queue: !1, easing: "easeInOutQuad" });
                              };
                              o = setTimeout(c, h);
                          },
                          "mouseleave.tooltip": function () {
                              (p = !1),
                                  ...
                                  setTimeout(function () {
                                      p !== !0 &&
                                          (k.velocity({ opacity: 0, translateY: 0, translateX: 0 }, { duration: 225, queue: !1 }),
                                          l.velocity(
            ...
            init: function (b) {
                ...
                (b = a.extend(c, b)),
                    a(this).each(function () {
                        ...
                        b.draggable ? (f.length && f.remove(), (f = a('<div class="drag-target"></div>').attr("data-sidenav", d)), a("body").append(f)) : (f = a()),
                            "left" == b.edge ? (e.css("transform", "translateX(-100%)"), f.css({ left: 0 })) : (e.addClass("right-aligned").css("transform", "translateX(100%)"), f.css({ right: 0 })),
                            e.hasClass("fixed") && window.innerWidth > 992 && e.css("transform", "translateX(0)"),
                            e.hasClass("fixed") &&
                                a(window).resize(function () {
                                    window.innerWidth > 992
                                        ? 0 !== a("#sidenav-overlay").length && i
                                            ? g(!0)
                                            : e.css("transform", "translateX(0%)")
                                        : i === !1 && ("left" === b.edge ? e.css("transform", "translateX(-100%)") : e.css("transform", "translateX(100%)"));
                                }),
                            b.closeOnClick === !0 &&
                                ...
                                .bind("pan", function (c) {
                                    if ("touch" == c.gesture.pointerType) {
                                        ...
                                        if (
                                            ...
                                            f.width(j),
                                            0 === h.length &&
                                                ((h = a('<div id="sidenav-overlay"></div>')),
                                        ...
                                        var l;
                                        "left" === b.edge
                                            ? ((l = d / b.menuWidth), h.velocity({ opacity: l }, { duration: 10, queue: !1, easing: "easeOutQuad" }))
                                            : ((l = Math.abs((d - window.innerWidth) / b.menuWidth)), h.velocity({ opacity: l }, { duration: 10, queue: !1, easing: "easeOutQuad" }));
                                    }
                                })
                                .bind("panend", function (c) {
                                    if ("touch" == c.gesture.pointerType) {
                                        ...
                                        k > 0 && (k = 0),
                                            ...
                                            "left" === b.edge
                                                ? (i && g <= 0.3) || g < -0.5
                                                    ? (0 !== k && e.velocity({ translateX: [0, k] }, { duration: 300, queue: !1, easing: "easeOutQuad" }),
                                                      d.velocity({ opacity: 1 }, { duration: 50, queue: !1, easing: "easeOutQuad" }),
                                                      f.css({ width: "50%", right: 0, left: "" }),
                                                      (i = !0))
                                                    : (!i || g > 0.3) &&
                                                      (a("body").css({ overflow: "", width: "" }),
                                                      e.velocity({ translateX: [-1 * b.menuWidth - 10, k] }, { duration: 200, queue: !1, easing: "easeOutQuad" }),
                                                      d.velocity(
                                                          { opacity: 0 },
                                                          {
                                                              duration: 200,
                                                ...
                                                : (i && g >= -0.3) || g > 0.5
                                                ? (0 !== l && e.velocity({ translateX: [0, l] }, { duration: 300, queue: !1, easing: "easeOutQuad" }),
                                                  d.velocity({ opacity: 1 }, { duration: 50, queue: !1, easing: "easeOutQuad" }),
                                                  f.css({ width: "50%", right: "", left: 0 }),
                                                  (i = !0))
                                                : (!i || g < -0.3) &&
                                                  (a("body").css({ overflow: "", width: "" }),
                                                  e.velocity({ translateX: [b.menuWidth + 10, l] }, { duration: 200, queue: !1, easing: "easeOutQuad" }),
                                                  d.velocity(
                                                      { opacity: 0 },
                                                      {
                                                          duration: 200,
                            ...
                            c.off("click.sidenav").on("click.sidenav", function () {
                                if (i === !0) (i = !1), (h = !1), g();
                                    ...
                                    c.css("overflow", "hidden"),
                                        ...
                                        a("body").append(f),
                                        "left" === b.edge
                                            ? (f.css({ width: "50%", right: 0, left: "" }), e.velocity({ translateX: [0, -1 * b.menuWidth] }, { duration: 300, queue: !1, easing: "easeOutQuad" }))
                                            : (f.css({ width: "50%", right: "", left: 0 }), e.velocity({ translateX: [0, b.menuWidth] }, { duration: 300, queue: !1, easing: "easeOutQuad" })),
        ...
        (a.scrollSpy = function (b, d) {
            ...
            return (
                ...
                b.on("scrollSpy:enter", function () {
                    ...
                    var b = a(this);
                    i[0] ? (a('a[href="#' + i[0].attr("id") + '"]').removeClass("active"), b.data("scrollSpy:id") < i[0].data("scrollSpy:id") ? i.unshift(a(this)) : i.push(a(this))) : i.push(a(this)),
        ...
        a(document).ready(function () {
            ...
            Materialize.updateTextFields = function () {
                ...
                a(b).each(function (b, c) {
                    var d = a(this);
                    a(c).val().length > 0 || c.autofocus || void 0 !== d.attr("placeholder")
                        ? d.siblings("label").addClass("active")
                        : a(c)[0].validity
                        ? d.siblings("label").toggleClass("active", a(c)[0].validity.badInput === !0)
            ...
            var i = function (a) {
                    var b = parseInt(a.parent().css("padding-left")),
                        c = -7 + b + "px";
                    a.velocity({ height: "30px", width: "30px", top: "-30px", marginLeft: c }, { duration: 300, easing: "easeOutExpo" });
                },
                j = function (a) {
                    var b = a.width() - 15,
                ...
                a(document).on("mouseout touchleave", k, function () {
                    if (!h) {
                        var b = a(this).children(".thumb"),
                            ...
                            d = 7 + c + "px";
                        b.hasClass("active") && b.velocity({ height: "0", width: "0", top: "10px", marginLeft: d }, { duration: 100 }), b.removeClass("active");
                    }
                }),
                    ...
                    return (
                        ...
                        this.each(function () {
                            ...
                            if (!a.isEmptyObject(e)) {
                                ...
                                h.length ? ((i = h.children(".autocomplete-content.dropdown-content").first()), i.length || h.append(j)) : ((i = d.next(".autocomplete-content.dropdown-content")), i.length || d.after(j)),
                                    i.length && (j = i);
                                var k = function (a, b) {
                                        var c = b.find("img"),
                                            d = b
                                ...
                                d.off("blur.autocomplete").on("blur.autocomplete", function () {
                                    ...
                                    d.off("keydown.autocomplete").on("keydown.autocomplete", function (a) {
                                        ...
                                        return 13 === c && g >= 0
                                            ? ((b = j.children("li").eq(g)), void (b.length && (b.trigger("mousedown.autocomplete"), a.preventDefault())))
                                            : void ((38 !== c && 40 !== c) || (a.preventDefault(), 38 === c && g > 0 && g--, 40 === c && g < d - 1 && g++, e.removeClass("active"), g >= 0 && j.children("li").eq(g).addClass("active")));
                                    }),
                            ...
                            .bind("pan", function (a) {
                                if ("touch" === a.gesture.pointerType) {
                                    ...
                                    ($curr_slide = i.find(".active")),
                                        Math.abs(d) > Math.abs(e) && $curr_slide.velocity({ translateX: c }, { duration: 50, queue: !1, easing: "easeOutQuad" }),
                                        4 === b && (c > h.innerWidth() / 2 || d < -0.65) ? (n = !0) : 2 === b && (c < (-1 * h.innerWidth()) / 2 || d > 0.65) && (m = !0);
                                    var f;
                                    m && ((f = $curr_slide.next()), 0 === f.length && (f = j.first()), f.velocity({ opacity: 1 }, { duration: 300, queue: !1, easing: "easeOutQuad" })),
                                        n && ((f = $curr_slide.prev()), 0 === f.length && (f = j.last()), f.velocity({ opacity: 1 }, { duration: 300, queue: !1, easing: "easeOutQuad" }));
                                }
                            })
            ...
            (a.fn.material_chip = function (c) {
                ...
                (d.hasAutocomplete = !a.isEmptyObject(e.autocompleteOptions.data)),
                    ...
                    (this.chips = function (b, c) {
                        ...
                        var g = a("#" + c);
                        d.hasAutocomplete &&
                            ((e.autocompleteOptions.onAutocomplete = function (a) {
                                                                ...
                                                                return [
                                                                    f.node(
                                                                        ...
                                                                        "data-pick=" +
                                                                            a.pick +
                                                                            " " +
                                                                            f.ariaAttr({ role: "gridcell", label: o, selected: !(!d || b.$node.val() !== o) || null, activedescendant: !!e || null, disabled: !!g || null })
                                                                    ),
                                                                    "",
    ...
    (function (a) {
        var b = {
            init: function (b) {
                ...
                return this.each(function (c) {
                    function e() {
                        "undefined" != typeof window.ontouchstart && (O[0].addEventListener("touchstart", n), O[0].addEventListener("touchmove", o), O[0].addEventListener("touchend", p)),
                    ...
                    function i(c) {
                        ...
                        if (
                            ...
                            (i = (-g * f * 2) / w),
                            (e = x >> 1),
                            b.fullWidth ? (k = "translateX(0)") : ((k = "translateX(" + (O[0].clientWidth - r) / 2 + "px) "), (k += "translateY(" + (O[0].clientHeight - s) / 2 + "px)")),
                            P)
                        ) {
                            var m = u % x,
                        ...
                        for (
                            (!b.noWrap || (u >= 0 && u < x)) &&
                                ((j = q[h(u)]),
                                a(j).hasClass("active") || (O.find(".carousel-item").removeClass("active"), a(j).addClass("active")),
                                (j.style[F] = k + " translateX(" + -f / 2 + "px) translateX(" + g * b.shift * i * d + "px) translateZ(" + b.dist * i + "px)"),
                                (j.style.zIndex = 0),
                                b.fullWidth ? (tweenedOpacity = 1) : (tweenedOpacity = 1 - 0.2 * i),
                            ...
                            b.fullWidth ? ((zTranslation = b.dist), (tweenedOpacity = d === e && f < 0 ? 1 - i : 1)) : ((zTranslation = b.dist * (2 * d + i * g)), (tweenedOpacity = 1 - 0.2 * (2 * d + i * g))),
                                (!b.noWrap || u + d < x) &&
                                    ((j = q[h(u + d)]),
                    ...
                    function j() {
                        var a, b, c, d;
                        (a = Date.now()), (b = a - H), (H = a), (c = t - G), (G = t), (d = (1e3 * c) / (1 + b)), (D = 0.8 * d + 0.2 * D);
                    }
                    function k() {
                        var a, c;
                    ...
                    return (
                        b.fullWidth && ((b.dist = 0), Q(), P && O.find(".carousel-fixed-item").addClass("with-indicators")),
                        O.hasClass("initialized")
                            ? (a(window).trigger("resize"), a(this).trigger("carouselNext", [1e-6]), !0)
            ...
            init: function (b) {
                return this.each(function () {
                    ...
                    e.length || (e = d.wrap(a('<div class="tap-target-wrapper"></div>')).parent()),
                        h.length || ((h = a('<div class="tap-target-content"></div>')), d.append(h)),
                        f.length || ((f = a('<div class="tap-target-wave"></div>')), g.length || ((g = c.clone(!0, !0)), g.addClass("tap-target-origin"), g.removeAttr("id"), g.removeAttr("style"), f.append(g)), e.append(f));
                    var i = function () {
                            e.is(".open") ||
                                (e.addClass("open"),
                                setTimeout(function () {
                        ...
                        k = function () {
                            ...
                            (N.top = t ? y : ""),
                                ...
                                (N.position = A),
                                e.css(N),
                                h.css({ width: B, height: C, top: D, right: G, bottom: E, left: F, padding: H, verticalAlign: I }),
